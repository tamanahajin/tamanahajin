...
![Siv3D](https://img.shields.io/badge/Siv3D-Game%20Jam%202025-4B9CD3?style=flat-square)
...
- Siv3D ゲームジャム 2025に参加し、C++ / Siv3Dでパズルアクションゲームを制作
- 新しい技術の検証結果や開発手順を文書化し、チームへ共有

## Game Jam

### あおむしクライム! / Siv3D ゲームジャム 2025

バンダイナムコスタジオ杯 | Siv3D ゲームジャム 2025に参加し、  
Siv3D / C++を使用して、パズルアクションゲーム「あおむしクライム!」を制作しました。

[作品紹介ページを見る](https://scrapbox.io/bnscup2025/%E3%81%82%E3%81%8A%E3%82%80%E3%81%97%E3%82%AF%E3%83%A9%E3%82%A4%E3%83%A0!)

#### 作品概要

あおむしクンの頭と尻尾を交互に固定しながら、金のリンゴを目指すパズルアクションゲームです。  
独特な操作感と、リンゴを拾うと体が伸びる仕組みを活かしたステージ攻略を制作しました。

#### 担当・工夫した点

- マウス入力による頭・尻尾の固定操作を実装
- ベジェ曲線を使用した、あおむしクンのうねるような動きを実装
- 葉っぱの種類による固定可能部位の制御
...
| Game Development | Unity, DirectX 12, Siv3D, Roblox Studio |
